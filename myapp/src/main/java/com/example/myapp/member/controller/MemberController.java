...
public class MemberController {
	...
	public String insertMember(@Validated Member member, String csrfToken, HttpSession session, Model model) {
		if (csrfToken == null || "".equals(csrfToken)) {
			throw new RuntimeException("CSRF TOKEN 이 없습니다.");
	...
	public String updateMember(@Validated Member member, HttpSession session, Model model) {
		try {
